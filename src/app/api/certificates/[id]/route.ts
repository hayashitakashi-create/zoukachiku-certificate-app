...
export async function GET(
  ...
  try {
    ...
    const response: CertificateResponse & { works?: any } = {
      ...
      works: {
        seismic: certificate.seismicWorks,
        barrierFree: certificate.barrierFreeWorks,
        energySaving: certificate.energySavingWorks,
        cohabitation: certificate.cohabitationWorks,
        childcare: certificate.childcareWorks,
        otherRenovation: certificate.otherRenovationWorks,
        longTermHousing: certificate.longTermHousingWorks,
      },
    };
