      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {certificateId && certificateInfo && (
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
            <h2 className="font-semibold text-lg text-blue-900 mb-3">証明書情報</h2>
        ...
        {showPreview && previewData ? (
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-2xl font-semibold mb-7 text-gray-900">
                (1) 実施した工事の種別
              </h2>
              ...
              {(previewData.workTypes?.work1?.extension ||
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第1号工事</h3>
                  <div className="space-y-2 ml-4">
                    {previewData.workTypes.work1.extension && <p className="text-base">✓ 1 増築</p>}
                    {previewData.workTypes.work1.renovation && <p className="text-base">✓ 2 改築</p>}
                    {previewData.workTypes.work1.majorRepair && <p className="text-base">✓ 3 大規模の修繕</p>}
                    {previewData.workTypes.work1.majorRemodeling && <p className="text-base">✓ 4 大規模の模様替</p>}
                  </div>
                </div>
              )}
              ...
              {(previewData.workTypes?.work2?.floorOverHalf ||
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第2号工事</h3>
                  <p className="text-sm text-gray-600 mb-3">
                    1棟の家屋でその構造上区分された数個の部分を独立して住居その他の用途に供することができるもののうちその者が区分所有する部分について行う次のいずれかに該当する修繕又は模様替
                  </p>
                  <div className="space-y-2 ml-4">
                    {previewData.workTypes.work2.floorOverHalf && <p className="text-base">✓ 1 床の過半の修繕又は模様替</p>}
                    {previewData.workTypes.work2.stairOverHalf && <p className="text-base">✓ 2 階段の過半の修繕又は模様替</p>}
                    {previewData.workTypes.work2.partitionOverHalf && <p className="text-base">✓ 3 間仕切壁の過半の修繕又は模様替</p>}
                    {previewData.workTypes.work2.wallOverHalf && <p className="text-base">✓ 4 壁の過半の修繕又は模様替</p>}
                  </div>
                </div>
              )}
              ...
              {(previewData.workTypes?.work3?.livingRoom ||
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第3号工事</h3>
                  <p className="text-sm text-gray-600 mb-3">
                    次のいずれか一室の床又は壁の全部の修繕又は模様替
                  </p>
                  <div className="grid grid-cols-2 gap-2 ml-4">
                    {previewData.workTypes.work3.livingRoom && <p className="text-base">✓ 1 居室</p>}
                    {previewData.workTypes.work3.kitchen && <p className="text-base">✓ 2 調理室</p>}
                    {previewData.workTypes.work3.bathroom && <p className="text-base">✓ 3 浴室</p>}
                    {previewData.workTypes.work3.toilet && <p className="text-base">✓ 4 便所</p>}
                    {previewData.workTypes.work3.washroom && <p className="text-base">✓ 5 洗面所</p>}
                    {previewData.workTypes.work3.storage && <p className="text-base">✓ 6 納戸</p>}
                    {previewData.workTypes.work3.entrance && <p className="text-base">✓ 7 玄関</p>}
                    {previewData.workTypes.work3.corridor && <p className="text-base">✓ 8 廊下</p>}
                  </div>
                </div>
              )}
              ...
              {(previewData.workTypes?.work4?.buildingStandard ||
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第4号工事（耐震改修工事）</h3>
                  <p className="text-sm text-gray-600 mb-3">
                    次の規定又は基準に適合させるための修繕又は模様替
                  </p>
                  <div className="space-y-2 ml-4">
                    {previewData.workTypes.work4.buildingStandard && <p className="text-base">✓ 1 建築基準法施行令第3章及び第5章の4の規定</p>}
                    {previewData.workTypes.work4.earthquakeSafety && <p className="text-base">✓ 2 地震に対する安全性に係る基準</p>}
                  </div>
                </div>
              )}
              ...
              {(previewData.workTypes?.work5?.pathwayExpansion ||
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第5号工事（バリアフリー改修工事）</h3>
                  <p className="text-sm text-gray-600 mb-3">
                    高齢者等が自立した日常生活を営むのに必要な構造及び設備の基準に適合させるための次のいずれかに該当する修繕又は模様替
                  </p>
                  <div className="grid grid-cols-2 gap-2 ml-4">
                    {previewData.workTypes.work5.pathwayExpansion && <p className="text-base">✓ 1 通路又は出入口の拡幅</p>}
                    {previewData.workTypes.work5.stairSlope && <p className="text-base">✓ 2 階段の勾配の緩和</p>}
                    {previewData.workTypes.work5.bathroomImprovement && <p className="text-base">✓ 3 浴室の改良</p>}
                    {previewData.workTypes.work5.toiletImprovement && <p className="text-base">✓ 4 便所の改良</p>}
                    {previewData.workTypes.work5.handrails && <p className="text-base">✓ 5 手すりの設置</p>}
                    {previewData.workTypes.work5.stepElimination && <p className="text-base">✓ 6 床の段差の解消</p>}
                    {previewData.workTypes.work5.doorImprovement && <p className="text-base">✓ 7 出入口戸の改良</p>}
                    {previewData.workTypes.work5.floorSlipPrevention && <p className="text-base">✓ 8 床材の滑り改良</p>}
                  </div>
                </div>
              )}
              ...
              {previewData.workTypes?.work6 && (
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-bold text-xl mb-3 text-blue-900">第6号工事（省エネ改修工事）</h3>
                  <p className="text-base text-gray-600 ml-4">※ 詳細項目が選択されています</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-6">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-base text-gray-700 mb-2">① 第1号工事〜第6号工事に要した費用の額</p>
                  <p className="text-3xl font-bold text-gray-900">{previewData.totalCost.toLocaleString()}円</p>
                </div>

                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-base text-gray-700 mb-2">② 補助金等の交付</p>
                ...
                <div className="p-4 bg-blue-50 border-2 border-blue-300 rounded-lg">
                  <p className="text-base text-blue-700 mb-2">③ 控除対象額（①から②を差し引いた額）</p>
                  <p className="text-4xl font-bold text-blue-600">{deductibleAmount.toLocaleString()}円</p>
                  {deductibleAmount >= 1000000 ? (
                    <p className="text-base text-green-700 mt-3">✓ 控除対象額が100万円以上です</p>
                  ) : (
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className="w-full bg-gray-500 text-white text-lg py-4 px-8 rounded-md hover:bg-gray-600 font-medium transition-colors"
                >
                  ← 入力内容を修正する
                </button>
                <button
                  ...
                  disabled={isSaving}
                  className="w-full bg-green-600 text-white text-lg py-4 px-8 rounded-md hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium transition-colors"
                >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-8 p-4 border-2 border-gray-200 rounded-lg">
              <h3 className="font-bold text-xl mb-5">第1号工事</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* 第2号工事 */}
            <div className="mb-8 p-4 border-2 border-gray-200 rounded-lg">
              <h3 className="font-bold text-xl mb-5">第2号工事</h3>
            ...
            {/* 第3号工事 */}
            <div className="mb-8 p-4 border-2 border-gray-200 rounded-lg">
              <h3 className="font-bold text-xl mb-5">第3号工事</h3>
              <p className="text-sm text-gray-600 mb-4">
                次のいずれか一室の床又は壁の全部の修繕又は模様替
              </p>
            ...
            {/* 第4号工事 */}
            <div className="mb-8 p-4 border-2 border-gray-200 rounded-lg">
              <h3 className="font-bold text-xl mb-5">第4号工事（耐震改修工事）</h3>
              <p className="text-sm text-gray-600 mb-4">
                次の規定又は基準に適合させるための修繕又は模様替
              </p>
            ...
            <div className="mb-8 p-4 border-2 border-gray-200 rounded-lg">
              ...
              <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                <h4 className="font-semibold text-lg mb-5 text-blue-900">
                  エネルギー使用の合理化に資する修繕改修
                </h4>
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-3 p-4 bg-gray-50 border border-gray-200 rounded text-sm">
              ...
              <div className="mb-6 p-4 bg-green-50 rounded-lg">
                <h4 className="font-semibold text-lg mb-5 text-green-900">
                  認定低炭素建築物新築等計画に基づく工事の場合
                </h4>
                ...
                <div className="mb-4 p-3 bg-white border border-green-200 rounded">
                  {/* 次に該当する修繕又は模様替 */}
                  <div className="mb-3">
                    <p className="text-sm font-medium mb-3 text-gray-700">次に該当する修繕又は模様替</p>
                  ...
                  <div>
                    <p className="text-sm font-medium mb-3 text-gray-700">上記1と併せて行ういずれかに該当する修繕又は模様替</p>
              ...
              <div className="mb-6 p-4 bg-purple-50 rounded-lg">
                <h4 className="font-semibold text-lg mb-5 text-purple-900">
                  改修工事後の住宅の一定の省エネ性能が証明される場合
                </h4>
                <div className="space-y-5">
                  ...
                  <div className="p-3 bg-white border border-purple-200 rounded">
                    ...
                    <div className="ml-3 space-y-3">
                      ...
                      <p className="text-sm font-medium mt-4 mb-3 text-gray-700">上記1と併せて行う次のいずれかに該当する修繕又は模様替</p>
              ...
              <div className="mb-6 p-4 bg-orange-50 rounded-lg">
                <h4 className="font-semibold text-lg mb-5 text-orange-900">
                  増改築による長期優良住宅建築等計画の認定により証明される場合
                </h4>
                <div className="space-y-5">
                  {/* エネルギーの使用の合理化に著しく資する... */}
                  ...
                  <div>
                    <label className="block text-base font-medium mb-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="ml-2 text-sm text-orange-600 hover:text-orange-800 underline"
                      >
                        （地域区分を確認する）
                      </a>
                    </label>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <button
              ...
              className="w-full bg-blue-600 text-white text-lg py-4 px-8 rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium transition-colors"
            >
              入力内容を確認する →
            </button>
            <p className="text-base text-gray-600 text-center mt-4">
